...
public class sfx_Chemical_Properties1 : MonoBehaviour
{
    ...
    // [Header("Lines&texts")]
    private string[] miniObjectives = { "Find WayOut (Pour out the correct Acid onto NAOH)", "Warmup to Survive - Find & Pickup Quick Lime(1/2)", "Warmup to Survive - Mix Quick Lime in Water to produce Heat(2/2)", "Explore the Area Find useful chemicals", "Explore the Area", "Mix FeS with HCL to Create Foul smell and scare the Animal", "Use Strontium Nitrate to Create Red Flare and Escape the Island" }; private int array_i = 1;
